...
$_['help_restrictions']					= 'Restrictions determine when extensions are <b>ENABLED</b>, and when the checkout is <b>DISABLED</b>. Use "Rules" to create restrictions based on specific criteria such as geo zone or customer group.';
...
$_['help_restriction_type']				= 'Select the type of extension to restrict, or select "Checkout" to restrict the checkout process.<br><br>If restricting extensions, the selected extensions will only be ENABLED when all rules are met. Disabled extensions are displayed in italics.<br><br>If restricting the checkout, the checkout will be DISABLED when all the rules are met.<br><br>If restricting Modules, note that ONLY standard modules can be restricted. Other modifications that are listed in Extensions > Modules, but are not actual modules, cannot be restricted.';
...
$_['text_onlyoptions_subtotal']			= 'Sub-Total of Only Options';
$_['text_shipping_cost']				= 'Shipping Cost';
$_['text_no_name']						= '(no name)';

$_['help_total_value']					= 'The cart&#39;s Sub-Total is normally used for calculations involving the total. To change this, use one of the following:<br><br>&bull; <b>Cheapest Product Total:</b> the product with the cheapest total (i.e. quantity x price); this will only affect percentages<br><br>&bull; <b>Pre-Discounted Sub-Total:</b> the sub-total of all products&#39; original prices, ignoring Special or Discount prices<br><br>&bull; <b>Non-Discounted Sub-Total:</b> the sub-total not including products with Special or Discount pricing' . ($type == 'Shipping' ? '' : '<br><br>&bull; <b>Shipping Cost:</b> the cost of the shipping option selected by the customer') . '<br><br>&bull; <b>Taxed Sub-Total:</b> the sub-total including any tax on products<br><br>&bull; <b>Total:</b> the total at the relative Sort Order of ' . ($type == 'Shipping' ? 'the "Shipping" Order Total<br><br>Products that do not require shipping are NOT included in values based on the sub-total.' : 'this extension.');
...
$_['text_all_rules_must_be_true']		= 'ALL rules must be true:';
$_['text_any_rule_can_be_true']			= 'ANY rule can be true:';
